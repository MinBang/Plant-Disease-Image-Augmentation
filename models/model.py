...
class CycleGAN:
    ...
    def build_model(self, args):
        ...
        if args.d_type == 'patch':
            ...
            nets.D_A = self.define_network(Discriminator(args.input_nc*2, attention=args.attention), init_func)
            nets.D_B = self.define_network(Discriminator(args.input_nc*2, attention=args.attention), init_func)                   
        ...
        optims.D = torch.optim.Adam(itertools.chain(nets.G_A2B.parameters(), nets.G_B2A.parameters()), lr=args.lr_D, betas=(args.beta1, args.beta2))
